...
class Graph:
    ...
    # Implement his function to detect any cycle in the graph :)
    def isCyclic(self):
        pass
...
# Assignment:
# Please implement a function isCyclic which must return True or False

"""
1. Fetch all the Cheapest Edge to Other Vertices by weight
Vertex      Cheapest Edge to Other Vertex By WEIGHT
{0}         0-5
{1}         1-6
{2}         2-3
{3}         2-3
...
3. Join the Components on the basis of min weighted edge
